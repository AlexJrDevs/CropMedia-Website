...
class AudioTranscribe:
    ...
    def generate_transcription(self, video_dir, video_path, words_per_line, time_stamp):
        # Locations to save
        transcript_location = os.path.join(video_dir, f"transcript_{time_stamp}.srt")

        
        # Creates the subs in srt file
        self.writeSubtitlesIntoFile(self.transcribe(video_path)["segments"], transcript_location, words_per_line)
